...
async function main() {
  ...
  // --- Sınıflar: Kurumda sadece 101 ve 102 (tek seviye A1 altında) ---
  ...
  const studentsData = [
    { name: 'Ayşe Yılmaz', email: 'ayse.yilmaz@email.com', classId: class101.id },
    { name: 'Mehmet Kaya', email: 'mehmet.kaya@email.com', classId: class101.id },
    { name: 'Elif Yıldız', email: 'elif.yildiz@email.com', classId: class101.id },
    { name: 'Burak Şahin', email: 'burak.sahin@email.com', classId: class101.id },
    { name: 'Ceren Acar', email: 'ceren.acar@email.com', classId: class101.id },
    { name: 'Zeynep Demir', email: 'zeynep.demir@email.com', classId: class102.id },
    { name: 'Can Öztürk', email: 'can.ozturk@email.com', classId: class102.id },
    { name: 'Derya Kılıç', email: 'derya.kilic@email.com', classId: class102.id },
    { name: 'Furkan Aydın', email: 'furkan.aydin@email.com', classId: class102.id },
    { name: 'Gamze Polat', email: 'gamze.polat@email.com', classId: class102.id },
    { name: 'Selin Arslan', email: 'selin.arslan@email.com', classId: class101.id },
    { name: 'Emre Çelik', email: 'emre.celik@email.com', classId: class101.id },
    { name: 'Hakan Yurt', email: 'hakan.yurt@email.com', classId: class101.id },
    { name: 'İrem Toprak', email: 'irem.toprak@email.com', classId: class101.id },
    { name: 'Kaan Özer', email: 'kaan.ozer@email.com', classId: class101.id },
    { name: 'Leyla Çetin', email: 'leyla.cetin@email.com', classId: class102.id },
    { name: 'Murat Doğan', email: 'murat.dogan@email.com', classId: class102.id },
    { name: 'Nazlı Erdem', email: 'nazli.erdem@email.com', classId: class102.id },
    { name: 'Deniz Aydın', email: 'deniz.aydin@email.com', classId: class101.id },
    { name: 'Ece Koç', email: 'ece.koc@email.com', classId: class101.id },
    { name: 'Oğuz Güneş', email: 'oguz.gunes@email.com', classId: class101.id },
    { name: 'Pelin Yılmaz', email: 'pelin.yilmaz@email.com', classId: class101.id },
    { name: 'Rıza Arslan', email: 'riza.arslan@email.com', classId: class101.id },
    { name: 'Sude Kara', email: 'sude.kara@email.com', classId: class102.id },
    { name: 'Tolga Özkan', email: 'tolga.ozkan@email.com', classId: class102.id },
    { name: 'Utku Demir', email: 'utku.demir@email.com', classId: class102.id },
  ];
